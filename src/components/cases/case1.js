  ...
  return (
    <motion.div exit={{ opacity: 0 }} className="sections-padding">
      ...
      <main className="case-container">
        ...
        <div>
          <img className="normal-img" src={img2} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img3} alt="" />
        </div>
        ...
        <div>
          <img className="normal-img" src={img6} alt="" />
        </div>
        ...
        <div>
          <img className="normal-img" src={img7} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img8} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img9} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img10} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img11} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img12} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img13} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img14} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img15} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img16} alt="" />
        </div>
        <div>
          <img className="normal-img" src={img17} alt="" />
        </div>
      </main>
